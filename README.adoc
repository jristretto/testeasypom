...
----
  <parent>
      <groupId>io.github.jristretto</groupId>
...
Then deploy using the publishing-central profile as in

[source,sh]
----
mvn -P publish-central deploy
----
...
Once published, the artifact will appear on the central repo under https://repo.maven.apache.org/maven2/io/github/jristretto/[jristretto part of central].
